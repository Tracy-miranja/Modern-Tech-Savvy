...
class LeaveTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'carryover_type'                    => 'nullable|string|in:full,fixed,percent',
            'carryover_value'                   => 'nullable|numeric|min:0',
            'carryover_expiry_months'           => 'nullable|integer|min:0',
            'minimum_service_days_required'     => 'required|integer|min:0',
            'min_interval_days'                 => 'nullable|integer|min:0',
                ...
                foreach ($jobCategoryIds as $jobCategoryId) {
                    LeavePolicy::firstOrCreate(
                        ...
                        [
                            ...
                            'carryover_type'                => $validated['carryover_type'] ?? 'full',
                            'carryover_value'               => $validated['carryover_value'] ?? null,
                            'carryover_expiry_months'       => $validated['carryover_expiry_months'] ?? null,
                            'minimum_service_days_required' => $validated['minimum_service_days_required'],
                            'min_interval_days'             => $validated['min_interval_days'] ?? null,
                            'is_encashable'                 => $validated['is_encashable'] ?? false,
                            'max_encashable_days'           => $validated['max_encashable_days'] ?? null,
    ...
    $rules = [
        ...
        'carryover_type' => ['sometimes','in:full,fixed,percent'],
        'carryover_value' => ['sometimes','nullable','numeric','min:0'],
        'carryover_expiry_months' => ['sometimes','nullable','integer','min:0'],
        'minimum_service_days_required' => ['sometimes','nullable','integer','min:0'],
        'min_interval_days' => ['sometimes','nullable','integer','min:0'],
        'is_encashable' => ['sometimes','in:0,1,true,false'],
        'max_encashable_days' => ['sometimes','nullable','integer','min:0'],
    ...
    try {
        ...
        $policyKeysPresent = collect([
            ...
            'max_carryover_days','carryover_type','carryover_value','carryover_expiry_months',
            'minimum_service_days_required','min_interval_days','is_encashable','max_encashable_days',
        ...
        if ($policyKeysPresent) {
            ...
            $versionedFields = [
                ...
                'carryover_expiry_months', 'minimum_service_days_required', 'min_interval_days',
