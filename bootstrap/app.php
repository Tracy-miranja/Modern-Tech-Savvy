...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withExceptions(function (Exceptions $exceptions) {
        ...
        // RoleOrImpersonation all throw this on a 403 - route non-AJAX
        // requests to somewhere the user actually has access to instead of
        // a bare JSON error, matching EnsureCorrectRole's own handling.
