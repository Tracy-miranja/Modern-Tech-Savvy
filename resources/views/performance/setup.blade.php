            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <h5 class="mb-0">Performance Setup</h5>
                            <small class="text-muted">Create appraisal cycles with their timeline and how KPI, OKR, and competency scores are weighted into an overall score.</small>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('business.performance.cycles.index', $business->slug) }}" class="btn btn-outline-secondary btn-sm">
                                <i class="bi bi-list-check me-1"></i> View Cycles
                            </a>
