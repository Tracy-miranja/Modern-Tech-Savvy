        ...
        <div class="row g-3">
            ...
            <div class="col-md-12 mb-3">
                ...
                <small class="text-muted d-block mt-1">
                    "Employee's Manager" walks the requester's real reporting line. "HR" routes straight to HR regardless of who manages the requester. "Department Head" requires the approver to hold the Head of Department role in the requester's own department.
                </small>
            </div>
            ...
            <div class="col-md-4">
                ...
                <small class="text-muted d-block mt-1">Skip the company's non-working days (set in Leave Settings) for this leave type.</small>
            </div>
