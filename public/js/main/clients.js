...
// The bulk checkbox "Assign Modules" UI (and its window.assignModules
// handler) was removed - it read a module's checked state from mere row
// existence rather than is_active, so an unchecked-then-saved module
// looked checked again on every reload since unchecking only ever
// soft-disabled the row, never removed it. Per-module activate/
// deactivate (with an optional expiry date) now lives on the client
// detail page instead - see clients/view.blade.php.
